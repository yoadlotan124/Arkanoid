...
public class Rectangle {
     ...
     * @return {@code true} if the point (including its radius)
     * is completely inside the rectangle, {@code false} otherwise.
     */
    ...
    public List<Point> intersectionPoints(Line line) {
        ...
        Point lowerRight = new Point(this.getStartX() + this.getWidth(), this.getStartY() + this.getHeight());
