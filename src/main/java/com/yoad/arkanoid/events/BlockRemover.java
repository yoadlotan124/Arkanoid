...
/**
 * The {@code BlockRemover} class is responsible for removing blocks from the game when they are
 * hit, and for keeping track of the number of remaining blocks using a {@link Counter}. This class
 * implements the {@link HitListener} interface and should be registered as a listener to any block
 * that should be removed upon being hit.
 */
