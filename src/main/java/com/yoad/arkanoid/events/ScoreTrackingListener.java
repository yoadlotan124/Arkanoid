...
/**
 * A {@code ScoreTrackingListener} is a {@link HitListener} that increases the score whenever a
 * block is hit.
 *
 * <p>Each time a hit occurs, this listener increases the score by 5 points. It is typically used to
