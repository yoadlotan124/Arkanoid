...
import com.yoad.arkanoid.notifiers.BallRemover;
import com.yoad.arkanoid.notifiers.BlockRemover;
import com.yoad.arkanoid.notifiers.Counter;
import com.yoad.arkanoid.notifiers.ScoreTrackingListener;
import com.yoad.arkanoid.physics.Collidable;
import com.yoad.arkanoid.sprites.Ball;
import com.yoad.arkanoid.sprites.Paddle;
import com.yoad.arkanoid.sprites.ScoreIndicator;
import com.yoad.arkanoid.sprites.Sprite;
import com.yoad.arkanoid.sprites.SpriteCollection;
import java.awt.Color;

/**
 * The game.Game class is responsible for managing the game logic, including the creation and update
 * of sprites, handling game environment interactions, and managing the game loop for rendering and
 * timing.
 */
public class Game {
  ...
  /**
   * Initializes the game by setting up the graphical user interface (GUI), creating the ball and
   * blocks (as sprites and collidables), and adding them to the game. A simple grid of blocks is
   * created for the game, and the ball is set up with an initial position and velocity.
   */
   ...
   * (calls timePassed on all sprites), draws the game, and sleeps for the appropriate time to
   * maintain the specified frames per second (FPS).
   */
  public void run() {
  ...
  //                    new File("C:/Users/Yoad/OneDrive/Desktop/First
  // year/OOP/ass5/freakbob.jpg"));
