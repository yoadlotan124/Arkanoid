...
/**
 * A {@code ScoreIndicator} is a {@link Sprite} that displays the current score at the top of the
 * screen.
 */
public class ScoreIndicator implements Sprite {
  ...
  /** Handles time-based updates. (Score display doesn't animate, so this is empty.) */
  @Override
